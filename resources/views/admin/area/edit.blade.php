...
@section('content')
    <h2>@lang('adminLang.area') @lang('adminLang.edit')</h2>
    <div class="row">
        <div class="col-6">
        <form method="POST" action="{{ route($baseRoute . '.update', ['area' => $record->id]) }}">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" class="form-control" id="desc" cols="30" rows="10">{{$record->phone}}</textarea>
                </div>
